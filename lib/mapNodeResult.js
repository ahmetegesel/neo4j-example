...
/**
 * Maps of Neo4j Query Result. If executed query is in this form
 * "`MATCH (n)-[r:DIRECTED]-(m) return n,m,r LIMIT 25`" it parse returning result
 ...
 * @param {*} result Array of records to be mapped from a query.
